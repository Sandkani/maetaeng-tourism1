...
--
ALTER TABLE `ratings`
  ADD CONSTRAINT `ratings_ibfk_1` FOREIGN KEY (`location_id`) REFERENCES `location1` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `statistic`
  ADD CONSTRAINT `statistic_ibfk_1` FOREIGN KEY (`locationID`) REFERENCES `location1` (`id`) ON DELETE CASCADE;
COMMIT;
